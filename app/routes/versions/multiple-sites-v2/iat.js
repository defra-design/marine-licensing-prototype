...
module.exports = function (router) {
  ...
  const base = "/versions/multiple-sites-v2/journey"; // prefix reused everywhere
  ...
  // ------- Start page -------------------------------------------
    router.get('/versions/multiple-sites-v2/start', (req, res) => {
      res.render('versions/multiple-sites-v2/start');
    });
