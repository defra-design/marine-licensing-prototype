...
module.exports = function (router) {
  ...
  const basePath = `/versions/multiple-sites-v2/low-complexity-v4/site-details/manual-entry`;
  ...
  router.get(`${basePath}/load-activity`, function (req, res) {
    ...
    res.redirect(`/versions/multiple-sites-v2/low-complexity-v4/site-details/${page}`);
  });
  ...
  router.post(`${basePath}/delete-site-router`, function (req, res) {
    ...
    if (sites.length === 0) {
      ...
      return res.redirect(`/versions/multiple-sites-v2/low-complexity-v4/marine-licence-start-page`);
    }
  ...
  router.post(`${basePath}/delete-all-sites-router`, function (req, res) {
    ...
    res.redirect(`/versions/multiple-sites-v2/low-complexity-v4/marine-licence-start-page`);
  });
