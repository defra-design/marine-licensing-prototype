...
// Enhanced clearing function for unified model
function clearUnifiedSiteData(session) {
    // Clear unified sites array
    delete session.data['unifiedSites'];
    delete session.data['currentManualEntrySiteId'];
    
    // Still clear legacy session keys for any remaining compatibility
    clearAllManualEntryData(session);
    
    console.log('Unified site data cleared');
}
