...
module.exports = function (router) {
  ...
  const base = "/versions/sample-plans-v1/journey"; // prefix reused everywhere
  ...
  // ------- Start page -------------------------------------------
    router.get('/versions/sample-plans-v1/start', (req, res) => {
      res.render('versions/sample-plans-v1/start');
    });
