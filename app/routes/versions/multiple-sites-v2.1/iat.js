...
module.exports = function (router) {
  ...
  const base = "/versions/multiple-sites-v2.1/journey"; // prefix reused everywhere
  ...
  // ------- Start page -------------------------------------------
    router.get('/versions/multiple-sites-v2.1/start', (req, res) => {
      res.render('versions/multiple-sites-v2.1/start');
    });
  ...
  allRouteItems.forEach((q) => {
    ...
    router.get(fullPath, (req, res) => {
        ...
        if (outcomeType) {
          ...
          if (outcomeType.heading) {
            ...
            if (outcomeType.heading === "Fill out an exemption notification") {
              ...
              if (article) {
                actionHref = `/versions/multiple-sites-v2.1/exemption/sign-in?article=${article}`;
              } else {
                actionHref = "/versions/multiple-sites-v2.1/exemption/sign-in";
              }
            }
          ...
          return res.render("versions/multiple-sites-v2.1/layouts/iat/outcome", view);
        }
      }
      ...
      if (isCard(q)) {
        ...
        res.render("versions/multiple-sites-v2.1/layouts/iat/card-selection", view);
      } else {
        ...
        res.render("versions/multiple-sites-v2.1/layouts/iat/radio-page", view);
      }
    });
  ...
  iat.outcomes
    ...
    .forEach((o) => {
      ...
      router.get(fullPath, (req, res) => {
        res.render("versions/multiple-sites-v2.1/layouts/iat/outcome", {
          h1: o.heading || "",
          bodyHtml: o.text,
