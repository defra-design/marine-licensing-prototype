...
// All paths include /versions/multiple-sites-v2/iat-lcml prefix.
...
module.exports = function (router) {
  ...
  // ------- Start page for iat-lcml -------------------------------------------
  router.get("/versions/multiple-sites-v2/iat-lcml", (req, res) => {
  ...
  allRouteItems.forEach((q) => {
    const fullPath = `${base}${q.route}`; // e.g. /versions/multiple-sites-v2/iat-lcml/sea
